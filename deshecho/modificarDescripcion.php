<?php 
  require_once('../public/conteo_id_descripcion.php')
 ?>
<!DOCTYPE html>
<html lang="es">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="proveedores.productos.php">
              <i class="mdi mdi-emoticon menu-icon"></i>
              <span class="menu-title">Proveedores</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pos.productos.php">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="../public/insertar_descripciones.php" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nuevo ID descripcion </label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" readonly="readonly" 
                              <?php 
                              $con_des = new conteo_id_descripcion();
                              $new_id = $con_des->get_conteo_id_descripcion();
                              echo 'value="'.$new_id.'"';
                             ?>
                            >
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control" name="descrip_1" id="descripcion1" rows="4"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Descripción 2</label>
                          <div class="col-sm-9">
                            <textarea class="form-control" name="descrip_2" id="descripcion1" rows="4"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Descripción 3</label>
                          <div class="col-sm-9">
                            <textarea class="form-control" name="descrip_3" id="descripcion1" rows="4"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Descripción 4</label>
                          <div class="col-sm-9">
                            <textarea class="form-control" name="descrip_4" id="descripcion1" rows="4"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
