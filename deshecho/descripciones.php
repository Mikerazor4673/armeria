              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Descripciones de Productos</h2>
                    <a type="button" href="modificarDescripcion.php" class="btn btn-success">Nuevo</a>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $consulta = "SELECT id_descripcion_producto, descripcion1_producto, descripcion2_producto, descripcion3_producto, descripcion4_producto FROM descripcion_producto";
                          ...
                          $fila = mysqli_fetch_array($resultado,MYSQLI_ASSOC);
                            ...
                            echo"<tr><td>".$fila['id_descripcion_producto']."</td></p>";
                            echo "<td>".$fila['descripcion1_producto']."</td>";
                            echo "<td>".$fila['descripcion2_producto']."</td>";
                            echo "<td>".$fila['descripcion3_producto']."</td>";
                            echo "<td>".$fila['descripcion4_producto']."</td>";
